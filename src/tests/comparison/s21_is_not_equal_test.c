...
START_TEST(test_not_equal_1) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 1);
}
...
START_TEST(test_not_equal_2) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 2);
}
...
START_TEST(test_not_equal_3) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 3);
}
...
START_TEST(test_not_equal_4) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 4);
}
...
START_TEST(test_not_equal_5) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 5);
}
...
START_TEST(test_not_equal_6) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 6);
}
...
START_TEST(test_not_equal_7) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 7);
}
...
START_TEST(test_not_equal_8) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 8);
}
...
START_TEST(test_not_equal_9) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 9);
}
...
START_TEST(test_not_equal_10) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 10);
}
...
START_TEST(test_not_equal_11) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 11);
}
...
START_TEST(test_not_equal_12) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 12);
}
...
START_TEST(test_not_equal_13) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 13);
}
...
START_TEST(test_not_equal_14) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 14);
}
...
START_TEST(test_not_equal_15) {
  ...
  s21_test_not_equal(decimal1, decimal2, expected, 15);
}
...
Suite *s21_not_equal_test(void) {
  ...
  suite = suite_create("s21_not_equal_test");
