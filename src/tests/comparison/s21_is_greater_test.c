...
START_TEST(test_greater_1) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 1);
}
...
START_TEST(test_greater_2) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 2);
}
...
START_TEST(test_greater_3) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 3);
}
...
START_TEST(test_greater_4) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 4);
}
...
START_TEST(test_greater_5) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 5);
}
...
START_TEST(test_greater_6) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 6);
}
...
START_TEST(test_greater_7) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 7);
}
...
START_TEST(test_greater_8) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 8);
}
...
START_TEST(test_greater_9) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 9);
}
...
START_TEST(test_greater_10) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 10);
}
...
START_TEST(test_greater_11) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 11);
}
...
START_TEST(test_greater_12) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 12);
}
...
START_TEST(test_greater_13) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 13);
}
...
START_TEST(test_greater_14) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 14);
}
...
START_TEST(test_greater_15) {
  ...
  s21_test_greater(decimal1, decimal2, expected, 15);
}
...
Suite *s21_greater_test(void) {
  ...
  suite = suite_create("s21_greater_test");
